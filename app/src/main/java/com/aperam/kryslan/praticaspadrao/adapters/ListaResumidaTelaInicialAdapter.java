...
import com.aperam.kryslan.praticaspadrao.tools.RoundedImageView;
import com.squareup.picasso.Picasso;
import com.turingtechnologies.materialscrollbar.INameableAdapter;

import java.util.List;

public class ListaResumidaTelaInicialAdapter extends RecyclerView.Adapter<ListaResumidaTelaInicialAdapter.MyViewHolder>{
    ...
    public ListaResumidaTelaInicialAdapter(Context c, List<TelaInicialCards> lista){
        this.c = c;
        mList = lista;
